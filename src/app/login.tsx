...
//     console.log("Login with", { email, password, rememberMe, userRole });
//     setIsLoading(false);
//   };

//   const handleGoogleLogin = () => {
//     console.log("Google login initiated for role:", userRole);
//     // TODO: Implement Google OAuth with role
//   };
...
//       label: "Inspector",
//       icon: UserCheck,
//       description: "Field inspection and data collection",
...
//       label: "Manager", 
//       icon: Settings,
//       description: "Project oversight and reporting",
...
//                       <h3 className={`font-semibold ${userRole === role.id ? 'text-blue-900' : 'text-gray-900'}`}>
//                         {role.label}
//                       </h3>
//                       <p className={`text-sm ${userRole === role.id ? 'text-blue-700' : 'text-gray-600'}`}>
//                         {role.description}
//                       </p>
//                     </div>
...
//           <p className="text-sm">
//             © 2024 BlueCarbon. Secure • Professional • Trusted
//           </p>
//         </div>
//       </div>
//     </div>
